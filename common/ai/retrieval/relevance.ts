 ...
 * not enough. Retrieving nothing is a safe outcome - the assistant says it does
 * not have enough approved information and routes to a human - whereas
 * retrieving something irrelevant invites an answer built on the wrong content.
 */
