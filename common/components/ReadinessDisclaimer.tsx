...
export function ReadinessDisclaimer() {
  return (
    <aside
      aria-label="Educational readiness disclaimer"
    ...
    >
      <div className="flex gap-4">
        ...
        <div className="text-sm leading-6 text-slate-600">
          <p className="font-bold text-[#071f4a]">Educational Preparation Disclaimer</p>
          <p className="mt-1">{readinessContent.disclaimer}</p>
        </div>
      </div>
    </aside>
  );
