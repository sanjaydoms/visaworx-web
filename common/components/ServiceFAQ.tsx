export function ServiceFAQ({
  ...
  return (
    <section aria-labelledby="service-faq-heading" className="space-y-6">
      <div>
        <p className="text-xs font-extrabold uppercase tracking-widest text-[#e6282f]">Clear Answers</p>
        <h2 id="service-faq-heading" className="mt-2 text-2xl font-extrabold text-[#071f4a] sm:text-3xl">
