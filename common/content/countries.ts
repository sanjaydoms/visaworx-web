...
const publishedCountries: Country[] = [
  {
    ...
    name: "United States",
    shortName: "USA",
    summary: "US B1/B2 visitor visa, F-1 student visa and business travel preparation for applicants from India.",
    popular: true,
    visaPurposes: ["Tourist", "Business", "Student", "Work"],
    overview: "Applying for a United States visa requires demonstrating clear travel intent, financial stability, and strong ties to India. Most non-immigrant visas involve an online DS-160 submission followed by an in-person consular interview.",
  ...
  },
  {
    ...
    name: "United Kingdom",
    shortName: "UK",
    summary: "UK Standard Visitor visa guidance for Indian travellers — tourism, short business trips, family visits and student entry.",
    popular: true,
    ...
    relatedServiceSlugs: ["tourist-visa", "student-visa", "refusal-review"],
  ...
  },
  {
    ...
    name: "Canada",
    shortName: "Canada",
    summary: "Canada TRV, visitor visa, study permit and business visit guidance for applicants from India.",
    popular: true,
    visaPurposes: ["Tourist", "Business", "Student", "Family"],
    ...
    relatedServiceSlugs: ["tourist-visa", "student-visa", "visa-readiness-review"],
  ...
  },
  {
    ...
    name: "Australia",
    shortName: "Australia",
    summary: "Australia visitor visa (subclass 600), student visa (subclass 500) and business stream guidance for Indian travellers.",
    popular: true,
    visaPurposes: ["Tourist", "Business", "Student", "Family"],
  ...
  },
  {
    ...
    summary: "New Zealand visitor visa preparation, NZeTA requirements and business travel guidance for applicants from India.",
    popular: false,
    visaPurposes: ["Tourist", "Business", "Student", "Family"],
  ...
  },
  {
    ...
    name: "Schengen Area",
    shortName: "Schengen",
    summary: "Short-stay Schengen visa (Type C) guidance for Indian passport holders, across 29 European member states.",
    popular: true,
  ...
  },
  {
    ...
    shortName: "UAE",
    summary: "Tourist and business entry permits for Dubai, Abu Dhabi and all UAE emirates, prepared for travellers from India.",
    popular: true,
    visaPurposes: ["Tourist", "Business", "Family"],
    ...
    relatedServiceSlugs: ["tourist-visa", "business-visa"],
  ...
  },
  {
    ...
    name: "Singapore",
    shortName: "Singapore",
    summary: "Singapore e-Visa guidance for Indian travellers — tourist visits, business travel and SG Arrival Card completion.",
    popular: true,
  ...
  },
  {
    ...
    name: "Japan",
    shortName: "Japan",
    summary: "Japan single and multiple-entry visitor visa preparation for leisure and business trips from India.",
    popular: true,
    visaPurposes: ["Tourist", "Business"],
    ...
    relatedServiceSlugs: ["tourist-visa", "documentation-review"],
  ...
  },
  {
    ...
    summary: "South Korea C-3-9 tourist visa guidance, K-ETA information and business visitor requirements for Indian applicants.",
    popular: false,
...
const awaitingCountries: Country[] = destinations
  ...
  .map((d) => ({
    ...
    name: d.name,
    summary: `Expert visa consultation and preparation support for travel to ${d.name} from India.`,
    popular: false,
    visaPurposes: [],
    overview: "",
    preparationChecklist: [],
